...
function App() {
  ...
  return (
    <main className="min-h-screen flex items-center justify-center flex-col gap-4">
      <h1 className="text-2xl font-semibold">React TypeScript Template</h1>
      ...
      <p className="w-[35ch] text-sm text-gray-400 text-center max-w-md">
        React TypeScript template using Tailwind and Framer Motion with formatter, linter, PWA, meta tags, and development scripts at the ready.
      </p>
      ...
      <div>
        <button
          className="flex items-center gap-1 text-white bg-gradient-to-r from-purple-500 to-pink-500 hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2"
